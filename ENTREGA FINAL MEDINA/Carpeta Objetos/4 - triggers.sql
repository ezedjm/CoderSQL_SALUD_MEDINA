...
-- insert
DELIMITER //
CREATE TRIGGER trg_before_insert_doctor
...
-- update
DELIMITER //
CREATE TRIGGER trg_before_update_doctor
...
-- delete
DELIMITER //
CREATE TRIGGER trg_before_delete_doctor
...
-- insert
DELIMITER //
CREATE TRIGGER trg_after_insert_doctor
...
-- update
DELIMITER //
CREATE TRIGGER trg_after_update_doctor
...
-- delete
DELIMITER //
CREATE TRIGGER trg_after_delete_doctor
...
-- update
DELIMITER //
CREATE TRIGGER trg_after_update_patient
...
-- delete
DELIMITER //
CREATE TRIGGER trg_after_delete_patient
